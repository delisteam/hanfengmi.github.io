    ...
    $.validationEngineLanguage = {
        newLang: function () {
            $.validationEngineLanguage.allRules = {
                ...
                "youku": {
                    // credit:jquery.h5validate.js / orefalo /http:\/\/v\.youku\.com\/v_show\/id_([\w]+)\.html.*/  |/\.swf$/i
                    "regex": /http:\/\/v\.youku\.com\/v_show\/id_([\w]+)\.html.*/,
                    //"regex":/^http:\/\/(www\.(acfun\.tv\/v\/ac|bilibili\.com\/video\/av)\d+|v\.youku\.com\/v_show\/id_([\w]+)\.html)([\?\/]{0,1}|[\?\/].*)$/,
                    //"regex":/\.swf$/i,
                    "alertText": "* 无效的视频地址",
                },
                "email": {
                ...
                "check_nickname": {
                    'url': '/u/ajax_check_nickname', /* 验证程序地址 */
                    'alertTextOk': '此昵称可用',
                    'alertText': '昵称已被占用，换一个试试。',
                    'alertTextLoad': '验证中请稍后。。。'
                },
//				"check_endtime":{
//					"nname":"check_endtime",// /^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{4}$/
//					"alertText":"截止时间必须大于开始时间",
//					"alertText2":"截止时间必须在开始时间后60天内 ",
//				},
